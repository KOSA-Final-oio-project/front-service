      ...
      <div class="form-container">
        ...
        <div class="form-group">
          ...
          <div class="flex-container">
            ...
            <!-- 중복확인 -> 인증요청 -->
            <div
              :class="{ 'dup-chk-btn': true, button: true, isActive: !isActive }"
        ...
        <div class="form-group">
          ...
          <div class="flex-container">
            <input type="tel" id="phone" v-model="user.phone" placeholder="010-0000-0000" />
            <div
              class="button"
              :class="{ 'certificate-btn': true, isActivep: !isActivep }"
              @click="phoneDuplicateCheck"
            >
              중복확인
            </div>
            <div
              :class="{ 'certificate-btn': true, button: true, isActivep: isActivep }"
  ...
  methods: {
    ...
    phoneDuplicateCheck() {
      axios
        ...
        .then((result) => {
          if (result.data == '이미 사용중인 휴대폰번호입니다.') {
    ...
    requestPhoneCertificate() {
      axios
        ...
        .then((result) => {
          this.phoneCheckMessage = result.data.code
          this.count += 1
        })
        .catch((error) => {
          console.log(error)
    ...
    confirmPhoneCertificate() {
      if (this.phoneCheckMessage == this.user.phoneCheckNumber) {
        alert('일치합니다.')
      } else {
        alert('일치하지 않습니다.')
        console.log(this.phoneCheckMessage)
        this.user.phoneCheckNumber == ''
      }
    },
