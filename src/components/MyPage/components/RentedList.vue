<template>
    <div class="rent-list-outer-container">
        <div class="rent-list-container">
            <ul class="rented-list-ul">
                <li
                    ...
                    :key="item.id"
                    class="rented-item"
                    :data-rented-product-no="item.rentedProductNo"
                >
                    <div class="left">
                    ...
                    <div class="right">
                        ...
                        <span class="button-container">
                            <button
                                v-if="showReviewButton(item.reviewStatus, item.status)"
                            ...
                            <button
                                v-if="showEndRentButton(item.status)"
        ...
        <transition name="overlay-fade">
            <div
                v-if="showModal || showConfirmationModal"
                class="modal-overlay"
                @click="closeModals"
            ></div>
        </transition>
