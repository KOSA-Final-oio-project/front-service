...
export default {
    ...
    methods: {
        registProduct() {
            ...
            // 서버로 전송
            axios.post(`http://192.168.1.86:9797/product-service/product/writeProduct/${this.selectedSido}/${this.selectedSiGunGu}/${this.selectedEupMyeonRo}/${this.selectedCategory}/${nickname}`, formData, {
                headers: {
